...
export function ChallengeDesignSystem({ locale }: { locale: string }) {
        ...
        <Container className="relative py-16 md:py-24">
          <div className="grid gap-12 md:grid-cols-[1.15fr_0.85fr] md:items-end">
            <div className="max-w-[760px]">
              ...
              >
                La même promesse, avec une identité qui prend enfin sa place.
              </h1>
              <p className="mt-6 max-w-[640px] text-[1.05rem] leading-8 text-[#42506b] md:text-[1.14rem]">
                Cette page teste une alternative plus éditoriale, plus statutaire et plus
                élégante, en gardant les mêmes familles de sections, le même discours
                business et une logique 100% système.
              </p>
              <div className="mt-10 flex flex-wrap gap-4">
                <ChallengeButton href="#HeroAnimated">Explorer la direction</ChallengeButton>
                ...
                <div className="grid gap-5 text-sm text-[#46526b]">
                  <div className="border-b border-[#e4dfd5] pb-4">
                    ...
                    <p className="mt-3 leading-7">
                      Sortir du rendu SaaS B2B attendu, sans perdre la discipline d’un
...
function ChallengeButton({
  ...
  const variants: Record<ButtonVariant, string> = {
    primary:
      "bg-[#3152e0] text-white shadow-[0_20px_40px_rgba(49,82,224,0.24)] hover:bg-[#2846cb]",
    secondary:
      "border border-[#d0d7f8] bg-white text-[#15213f] hover:border-[#3152e0] hover:text-[#3152e0]",
    ghost:
      "border border-white/20 bg-white/10 text-white hover:border-white/40 hover:bg-white/15",
    quiet:
      "border border-[#c8cedb] bg-[#f2efe7] text-[#17213b] hover:border-[#3152e0]",
  };
            ...
            <div className="grid gap-10 px-8 py-10 md:grid-cols-[0.9fr_1.1fr] md:px-10 md:py-12">
              ...
              <div className="space-y-5">
                ...
                <div className="overflow-hidden rounded-[28px] border border-white/12 bg-[#f7f8fc] p-4 text-[#11192f]">
                  ...
                  <div className="relative overflow-hidden rounded-[22px] border border-[#e3e7f2] bg-[#f2f5fb] shadow-[0_24px_55px_rgba(17,25,47,0.08)]">
          ...
          >
            ...
            <div className={cn(reversed && "md:order-1")}>
              <div className={cn("rounded-[28px] border p-4", styles.panel)}>
                ...
                <div className={cn("relative overflow-hidden rounded-[22px] border", styles.innerBorder)}>
...
function DisplayTitle({
  ...
  return (
    <h2
      className={cn(
        "text-[2.4rem] leading-[0.96] tracking-[-0.045em] md:text-[4rem]",
        fraunces.className,
        className,
      )}
    >
