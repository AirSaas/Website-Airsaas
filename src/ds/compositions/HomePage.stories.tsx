  ...
  return (
    <div className="w-full">
      ...
      <FeatureFrame
        ...
        ctaLabel="Découvrir"
        imageSrc="https://placehold.co/1125x696/e8eafc/3a51e2?text=Agent+IA"
      />
      ...
      <FeatureFrame
        ...
        title="en temps réel"
        description="Visualisez instantanément la charge de vos équipes, identifiez les surcharges et anticipez les conflits de ressources."
        checklist={["Vision macro des capacités", "Alertes automatiques de surcharge", "Simulation de scénarios", "Export pour le COMEX"]}
        ctaLabel="En savoir plus"
        imageSrc="https://placehold.co/1125x731/fffbeb/e58d05?text=Capacity+Planning"
        imageBgColor="#fffbeb"
      />
      ...
      <FeatureFrame
        ...
        checklist={["Roadmap partagée", "Mises à jour en temps réel", "Notifications automatiques", "Vue timeline"]}
        ctaLabel="Découvrir la roadmap"
        imageSrc="https://placehold.co/1125x696/e8eafc/3a51e2?text=Roadmap"
      />
      ...
      <FeatureFrame
        ...
        title="automatisé"
        description="Générez des rapports flash en un clic pour vos comités de pilotage. Plus besoin de compiler des données manuellement."
        checklist={["Rapport en 1 clic", "Données consolidées", "Format COMEX-ready", "Historique complet"]}
        ctaLabel="Voir un exemple"
        imageSrc="https://placehold.co/1125x731/fffbeb/e58d05?text=Flash+Report"
        imageBgColor="#fffbeb"
      />
      ...
      <FeatureFrame
        imagePosition="right"
        tag="Priorisation"
        titleHighlight="Scoring"
        title="intelligent"
        description="Évaluez et comparez vos projets avec un scoring objectif. Priorisez en fonction de la valeur et de la capacité disponible."
        checklist={["Scoring multicritère", "Matrice de priorisation", "Alignement stratégique", "Décision data-driven"]}
        ctaLabel="En savoir plus"
        imageSrc="https://placehold.co/1125x696/e8eafc/3a51e2?text=Scoring"
      />
      ...
      <FeatureFrame
        imagePosition="left"
        tag="Gouvernance"
        titleHighlight="Pilotage"
        title="de portefeuille"
        description="Centralisez la gouvernance de votre portefeuille de projets. Une vue unifiée pour le management et les équipes opérationnelles."
        checklist={["Vue portefeuille 360°", "Suivi des jalons", "Gestion des risques", "Tableau de bord DSI"]}
        ctaLabel="Découvrir"
        imageSrc="https://placehold.co/1125x731/fffbeb/e58d05?text=Gouvernance"
        imageBgColor="#fffbeb"
      />
      ...
      <ValuePropositionFrame
        variant="dark"
        titleHighlight="Intégrations"
        title="natives avec vos outils"
        subtitle="AirSaas se connecte à vos outils existants en quelques clics."
      >
      ...
      <ValuePropositionFrame
        ...
        title="choisir AirSaas ?"
        subtitle="La plateforme conçue pour les PMO qui veulent enfin piloter, pas subir."
      >
