...
export default function DesignSystemPage() {
  return (
    <div>
      ...
      <FeatureSection heading="Visualisez l'avancement de tous vos projets" description="Suivez en temps réel l'état d'avancement de chaque projet, identifiez les risques et prenez les bonnes décisions au bon moment." image="/assets/images/home_app_screen-min.png" imageAlt="Feature screenshot" />

      <SectionLabel name="FeatureSection-reversed" />
      <FeatureSection heading="Priorisez avec votre comité de direction" description="Alignez les priorités entre la DSI et le top management grâce à des critères objectifs et une vue partagée du portefeuille." image="/assets/images/home_app_screen-min.png" imageAlt="Feature screenshot" reversed bgColor="alt" />
      ...
      <SolutionHero badge="SOLUTION" heading={<>Pilotez votre <span className="text-primary">portefeuille de projets</span></>} description="Visualisez l'avancement de tous vos projets en un coup d'oeil." image="/assets/images/home_app_screen-min.png" imageAlt="AirSaaS Portfolio" />
      ...
      <LpHero badge="PPM MODERNE" heading={<>Le PPM <span className="text-primary">moderne</span> pour les DSI</>} description="Pilotez votre portefeuille de projets." trustBadges={[{ icon: "shield", text: "ISO 27001" }, { icon: "flag", text: "Hébergé en France" }]} tabs={[{ label: "Portfolio", image: "/assets/images/home_app_screen-min.png" }, { label: "Quarter plan", image: "/assets/images/home_app_screen-min.png" }]} />
      ...
      <LpFeatureCard badge="PORTFOLIO" heading="Centralisez tous vos projets" description="Une vue unique pour piloter votre portefeuille." bullets={["Vue consolidée", "Indicateurs temps réel", "Alertes automatiques"]} image="/assets/images/home_app_screen-min.png" imageAlt="Portfolio" />
