...
export default function HomePage() {
  return (
    <>
      ...
      <FeatureSection heading={<><strong className="font-extrabold">Grâce à sa marketplace AirSaas</strong> s&apos;intègre nativement à vos outils du quotidien</>} description="Centralisez toutes vos informations cruciales (tickets, jalons…) depuis vos outils de gestion de tâches sur AirSaas, et diffusez-les via vos canaux de communication interne. Tout le monde est au diapason, et vous gouvernez de manière optimale." image="/assets/images/Automation - integrations.webp" imageAlt="Automation - integrations" bgColor="alt" />
